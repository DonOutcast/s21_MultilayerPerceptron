...
//
// auto s21::MatrixNetwork::get_local_grads(vector_double &local_grads, const
// vector_double &expected_values,
//                                         size_type layer) -> void {
//    if (local_grads.empty()) {
//        for (auto i = 0; i < this->m_neurons_.back().GetRow(); i++) {
//            double error_ = expected_values[i] -
//            this->m_neurons_.back()[i][0]; local_grads.push_back(error_ *
//            this->activate_function_derivative(this->m_neurons_.back()[i][0]));
//        }
//    } else {
...
//            }
//            new_grads_.push_back(teta_ *
//            activate_function_derivative(this->m_neurons_[layer][i][0]));
//        }
//
...
//}
//
// auto s21::MatrixNetwork::back_propagation(vector_double &expected_values) ->
// void {
...
//                this->m_weights_[i][k][j] += s21::MatrixNetwork::step_ *
//                local_grads_[k] * this->m_neurons_[i][j][0];
//            }
//        }
//    }
//}
...
//}
//
// auto s21::MatrixNetwork::check_topology(const std::vector<size_type>
// &topology) -> bool {
//    bool result_ = true;
...
//                for (size_type j = 0; j < this->m_weights_[layer].GetColumn();
//                j++) {
...
//}
//
// auto s21::MatrixNetwork::get_result_vector() ->
// s21::MatrixNetwork::const_vec_double {
...
//    }
//
//    auto MatrixNetwork::set_layers(std::initializer_list<size_t> items) ->
//    void {
...
//                m_weights_.emplace_back(S21Matrix(m_topology_[i + 1],
//                m_topology_[i])); init_weight_matrix(m_weights_.back());
//            }
//        }
//    }
...
//    auto MatrixNetwork::feed_init_value(const std::vector<double> &values) ->
//    void {
//        for (size_t i = 0; i < values.size(); i++) {
...
//                m_neurons_[i + 1](j, 0) =
//                        activate_function(m_neurons_[i + 1](j, 0) +
//                        m_biases_[i]);
//            }
//        }
//    }
